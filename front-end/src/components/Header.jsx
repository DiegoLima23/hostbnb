...
const Header = () => {
  ...
  <header className='shadow-md'>
    <div className='flex items-center justify-between px-4 sm:px-8 py-2 max-w-7xl mx-auto '>
      ...
      <Link to="/" className='flex items-center border border-gray-300 pr-4 py-2 pl-6 rounded-full shadow-md'>
      ...
      <Link to="/login" className='hidden lg:flex items-center border border-gray-300 pr-4 py-2 pl-6 rounded-full shadow-md gap-1.5'>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
       ...
       <p className="sm:max-w-32 max-w-20 truncate">Diego Lima</p>
      </Link>
